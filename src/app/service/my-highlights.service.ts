...
export class MyHighlightsService {
  ...
  highlights: Highlight[] = [
    ...
    { category: 'CI/CD', text: "4+ years with enterprise CI/CD tools; inc. Jenkins, uDeploy, Harness, Blackduck, Checkmarx, etc." },
    ...
    { category: 'Test Automation', text: "Drove test coverage up 20% on a hertiage project through direct development and coaching" },
    ...
    { category: 'Data Pipelining', text: "Developed ETL pipeline in Kafka+Java+MongoDB to process 1.5TB/day from a security platform" },
    ...
    { category: 'Cloud', text: "Hands-on work with private and public cloud; inc. ECS, Fargate, S3" },
